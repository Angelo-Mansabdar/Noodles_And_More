...
@section('content')
    <div class="max-w-7xl mx-auto px-6 py-8">
        <h1 class="text-3xl font-bold mb-6 text-center">Admin - Manage Products</h1>
                        ...
                        @foreach($products as $product)
                            <tr class="border-b hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 space-x-2">
                                    <!-- Edit Button -->
                                    <a href="{{ route('products.edit', $product) }}" class="inline-block px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 text-sm">Edit</a>
